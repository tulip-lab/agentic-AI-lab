...
The target scene contains two faceless humanoid figures interacting with dark and light spheres in front of a large black-and-ivory Taijitu.
...
| Reference | Purpose |
| --- | --- |
| [Motion reference](assets/motion-reference.gif) | Defines the composition, two-character action sequence, sphere interactions, timing, and loop behaviour. |
...
- retain two distinguishable humanoid figures throughout the sequence;
